# KVForge
A Redis-inspired in-memory KV store written in modern C++17/20. Features a custom TCP server, RESP protocol parser, concurrent hash map, TTL expiry, and LRU eviction. Built from scratch.
